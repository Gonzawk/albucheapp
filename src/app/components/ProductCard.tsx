...
export default function ProductCard({ producto }: ProductCardProps) {
  ...
  return (
    <div className="bg-white p-6 shadow-lg rounded-lg text-center relative w-80 min-h-[450px] flex flex-col justify-between">
      ...
      <span className="text-red-600 font-bold text-xl block mt-4">${producto.precio}</span>
      ...
      {mostrarOpciones && (
        ...
        >
          <div className="bg-white p-6 rounded-lg shadow-lg w-11/12 max-w-md text-center">
            ...
            <button onClick={() => setMostrarOpciones(false)} className="mt-2 bg-red-500 text-white px-4 py-2 rounded w-full">
              Volver atras
            </button>
          </div>
        </motion.div>
